import React14, { createContext, forwardRef, createElement, useState, useEffect, useRef, useCallback, useContext } from 'react';
import { useActiveAccount, useActiveWalletChain, useSendTransaction, ConnectButton } from 'thirdweb/react';
import { SUPPORTED_CHAINS as SUPPORTED_CHAINS$1, CONTRACT_CONSTANTS, getContractAddress as getContractAddress$1 } from '@tippingchain/sdk';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { SUPPORTED_CHAINS, NETWORK_CONFIGS, isContractDeployed, getContractAddress } from '@tippingchain/contracts-interface';
      ...
      try {
        ...
        if (relayService && relayService.getQuote) {
          const quote = await relayService.getQuote({
            ...
            toChainId: SUPPORTED_CHAINS$1.APECHAIN,
...
var NATIVE_TOKENS = {
  ...
  421614: { symbol: "ETH", name: "Ethereum (Arbitrum Sepolia)", decimals: 18, icon: "\u{1F9EA}", color: "#28A0F0" },
  84532: { symbol: "ETH", name: "Ethereum (Base Sepolia)", decimals: 18, icon: "\u{1F9EA}", color: "#0052FF" }
};
var CHAIN_TOKENS = [
  {
    chainId: 1,
  ...
  },
  {
    ...
    tokens: [
      { symbol: "USDC", name: "USD Coin (Arbitrum Sepolia)", decimals: 6, address: "0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d", icon: "\u{1F4B5}", color: "#2775CA", isStable: true, popular: true }
    ]
  },
  {
    chainId: 84532,
    // Base Sepolia (testnet destination)
    chainName: "Base Sepolia",
    native: NATIVE_TOKENS[84532],
    tokens: [
      { symbol: "USDC", name: "USD Coin (Base Sepolia)", decimals: 6, address: "0x036CbD53842c5426634e7929541eC2318f3dCF7e", icon: "\u{1F4B5}", color: "#2775CA", isStable: true, popular: true }
    ]
  }
];
...
var MultiTokenTippingInterface = ({
  ...
  const [approvalState, setApprovalState] = useState("none" /* NONE */);
  ...
  useEffect(() => {
    ...
    if (selectedToken.address && activeChain) {
      const checkApproval = async () => {
        try {
          const contractAddress = getContractAddress$1(activeChain.id);
          if (!contractAddress) {
            setApprovalState("none" /* NONE */);
            return;
          }
  ...
  if (!chainTokens.length) {
    return /* @__PURE__ */ jsxs("div", { className: `bg-red-50 border border-red-200 rounded-lg p-6 text-center ${className}`, children: [
      /* @__PURE__ */ jsx(AlertCircle, { className: "w-8 h-8 text-red-500 mx-auto mb-2" }),
      /* @__PURE__ */ jsx("p", { className: "text-red-700", children: "Unsupported chain. Please switch to a supported network." })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: `bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl shadow-lg p-6 max-w-md mx-auto ${className}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-4", children: [
      /* @__PURE__ */ jsx(Target, { className: "w-6 h-6 text-blue-600 mr-2" }),
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-800", children: "Multi-Token \u2192 ApeChain" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "bg-white rounded-lg p-4 mb-4 border", children: /* @__PURE__ */ jsxs("div", { className: "font-medium text-gray-800", children: [
      "Creator ID #",
      creatorId
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700", children: "Select Token" }),
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("svg", { className: `w-3 h-3 mr-1 ${loadingBalance ? "animate-spin" : ""}`, fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" }) }),
                "Refresh"
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2 max-h-40 overflow-y-auto", children: chainTokens.map((token) => {
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-lg mr-2", children: token.icon }),
                      /* @__PURE__ */ jsx("span", { className: "font-medium", children: token.symbol })
                    ] }),
                    /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: token.name })
                  ] }),
                  isSelected && /* @__PURE__ */ jsx(CheckCircle, { className: "w-4 h-4 text-blue-500" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-600 mt-1", children: [
                  /* @__PURE__ */ jsx(Wallet, { className: "w-3 h-3 inline mr-1" }),
                  loadingBalance ? /* @__PURE__ */ jsx("span", { className: "animate-pulse", children: "Loading..." }) : formatTokenAmount2(balance.toString(), token.decimals)
                ] }),
                token.isStable && /* @__PURE__ */ jsx("div", { className: "text-xs text-green-600 font-medium mt-1", children: "Stablecoin" }),
                token.popular && /* @__PURE__ */ jsx("div", { className: "text-xs text-orange-600 font-medium mt-1", children: "Popular" })
              ]
            },
            token.symbol
          );
      ...
      selectedToken && /* @__PURE__ */ jsxs("div", { children: [
        ...
        balanceWarning && /* @__PURE__ */ jsxs("div", { className: "mt-2 p-2 bg-red-50 border border-red-200 rounded text-sm text-red-700", children: [
          /* @__PURE__ */ jsx(AlertCircle, { className: "w-4 h-4 inline mr-1" }),
          balanceWarning
        ] })
      ] }),
      amount && (feePreviewLoading || conversionQuote) && /* @__PURE__ */ jsxs("div", { className: `border rounded-lg p-4 ${conversionQuote?.isReal ? "bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200" : "bg-gradient-to-r from-yellow-50 to-orange-50 border-yellow-200"}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
            /* @__PURE__ */ jsx(Coins, { className: "w-4 h-4 text-blue-600 mr-1" }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-blue-800", children: "Real Fee Preview" })
          ] }),
          feePreviewLoading ? /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 animate-spin text-blue-600" }) : conversionQuote?.isReal ? /* @__PURE__ */ jsx(CheckCircle, { className: "w-4 h-4 text-green-600" }) : /* @__PURE__ */ jsx(AlertCircle, { className: "w-4 h-4 text-yellow-600" })
        ] }),
        feePreviewLoading ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center py-4", children: [
          /* @__PURE__ */ jsx(Loader2, { className: "w-5 h-5 animate-spin text-blue-600 mr-2" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-600", children: "Calculating real fees..." })
        ] }) : conversionQuote && /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
          conversionQuote.error && /* @__PURE__ */ jsx("div", { className: "bg-yellow-100 border border-yellow-300 rounded p-2", children: /* @__PURE__ */ jsxs("div", { className: "text-xs text-yellow-800 font-medium", children: [
            "\u26A0\uFE0F ",
            conversionQuote.error
          ] }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-700", children: "You send:" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-700", children: "USD Value:" }),
            /* @__PURE__ */ jsxs("span", { className: "font-semibold", children: [
              "$",
              conversionQuote.usdValue.toFixed(2)
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex justify-center text-blue-600 my-2", children: /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4" }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm text-red-600", children: [
            /* @__PURE__ */ jsx("span", { children: "Platform fee (5%):" }),
            /* @__PURE__ */ jsxs("span", { className: "font-semibold", children: [
              "-",
          ...
          /* @__PURE__ */ jsxs("div", { className: "border-t pt-2 space-y-2", children: [
            /* @__PURE__ */ jsx("div", { className: "text-xs font-medium text-gray-600 mb-2", children: "After Platform Fee Distribution:" }),
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm text-green-600", children: [
              /* @__PURE__ */ jsx("span", { children: "Creator receives:" }),
              /* @__PURE__ */ jsx("span", { className: "font-semibold", children: conversionQuote.creatorShareRaw ? /* @__PURE__ */ jsxs("span", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm text-blue-600", children: [
              /* @__PURE__ */ jsx("span", { children: "Business receives:" }),
              /* @__PURE__ */ jsx("span", { className: "font-semibold", children: conversionQuote.businessShareRaw ? /* @__PURE__ */ jsxs("span", { children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "border-t pt-2", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm font-medium", children: [
            /* @__PURE__ */ jsx("span", { className: "text-purple-700", children: "Final USDC on ApeChain:" }),
            /* @__PURE__ */ jsxs("span", { className: "text-purple-700", children: [
              "~$",
              conversionQuote.estimatedUsdc.toFixed(2)
            ] })
          ] }) }),
          /* @__PURE__ */ jsx("div", { className: `text-xs mt-3 p-2 rounded ${conversionQuote.isReal ? "bg-green-50 text-green-700 border border-green-200" : "bg-yellow-50 text-yellow-700 border border-yellow-200"}`, children: conversionQuote.isReal ? /* @__PURE__ */ jsxs("span", { children: [
            "\u2705 Real fees calculated from Creator #",
            creatorId,
            " tier settings"
          ] }) : /* @__PURE__ */ jsx("span", { children: "\u26A0\uFE0F Estimated fees - actual amounts may differ" }) })
        ] })
      ] }),
      approvalState !== "none" /* NONE */ && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        approvalState === "needed" /* NEEDED */ && /* @__PURE__ */ jsx("div", { className: "bg-yellow-50 border border-yellow-200 rounded-lg p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-medium text-yellow-800", children: "Token approval required" }),
            /* @__PURE__ */ jsxs("div", { className: "text-xs text-yellow-600", children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: isLoading ? /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 animate-spin" }) : "Approve"
            }
          )
        ] }) }),
        approvalState === "pending" /* PENDING */ && /* @__PURE__ */ jsx("div", { className: "bg-blue-50 border border-blue-200 rounded-lg p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 text-blue-600 animate-spin mr-2" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm text-blue-700", children: "Approval transaction pending..." })
        ] }) }),
        approvalState === "approved" /* APPROVED */ && /* @__PURE__ */ jsx("div", { className: "bg-green-50 border border-green-200 rounded-lg p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx(CheckCircle, { className: "w-4 h-4 text-green-600 mr-2" }),
          /* @__PURE__ */ jsx("span", { className: "text-sm text-green-700", children: "Token approved! You can now send the tip." })
        ] }) })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: isLoading ? /* @__PURE__ */ jsxs("span", { className: "flex items-center justify-center", children: [
...
var ChainSelector = ({
  ...
  onChange,
  label = "Select Chain",
  excludeChains = [SUPPORTED_CHAINS.APECHAIN],
  // Exclude ApeChain by default as it's destination only
  className = "",
  disabled = false
}) => {
  const chainOptions = Object.entries(SUPPORTED_CHAINS).filter(([_, chainId]) => !excludeChains.includes(chainId)).map(([key, chainId]) => {
...
var AdminInterface = ({
  ...
  if (!account) {
    return /* @__PURE__ */ jsx("div", { className: `max-w-4xl mx-auto p-6 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center", children: [
      /* @__PURE__ */ jsx(Shield, { className: "w-12 h-12 text-yellow-500 mx-auto mb-4" }),
      /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-yellow-800 mb-2", children: "Admin Access Required" }),
      /* @__PURE__ */ jsx("p", { className: "text-yellow-700 mb-4", children: "Connect your wallet to access the TippingChain admin interface" }),
      /* @__PURE__ */ jsx(ConnectButton, { client, theme: "light" })
    ] }) });
  }
  return /* @__PURE__ */ jsxs("div", { className: `max-w-6xl mx-auto p-6 space-y-6 ${className}`, children: [
    /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 text-white", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-2", children: "TippingChain Admin" }),
        /* @__PURE__ */ jsx("p", { className: "text-blue-100", children: "Multi-admin creator management & platform analytics" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-4", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            title: "Refresh data",
            children: /* @__PURE__ */ jsx(RefreshCw, { className: `w-5 h-5 ${loadingCreators || loadingStats ? "animate-spin" : ""}` })
          }
        ),
        /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm text-blue-100", children: "Connected" }),
    ...
    showChainSelector && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg p-6 shadow-sm border", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold text-gray-900", children: "Network Selection" }),
        /* @__PURE__ */ jsx("div", { className: "flex items-center space-x-2", children: isContractAvailable ? /* @__PURE__ */ jsxs("span", { className: "flex items-center text-green-600 text-sm", children: [
          /* @__PURE__ */ jsx(CheckCircle, { className: "w-4 h-4 mr-1" }),
          "Contract Deployed"
        ] }) : /* @__PURE__ */ jsxs("span", { className: "flex items-center text-red-600 text-sm", children: [
      ...
      contractAddress && /* @__PURE__ */ jsxs("div", { className: "mt-3 text-sm text-gray-600", children: [
        /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Contract:" }),
        /* @__PURE__ */ jsx("span", { className: "font-mono ml-1", children: contractAddress })
      ] })
    ] }),
    showPlatformStats && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg p-6 shadow-sm border", children: [
      /* @__PURE__ */ jsxs("h2", { className: "text-lg font-semibold text-gray-900 mb-4 flex items-center", children: [
        /* @__PURE__ */ jsx(BarChart3, { className: "w-5 h-5 mr-2" }),
        "Platform Statistics"
      ] }),
      loadingStats ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center py-8", children: [
        /* @__PURE__ */ jsx(Loader2, { className: "w-6 h-6 animate-spin text-blue-600 mr-2" }),
        /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Loading statistics..." })
      ] }) : platformStats ? /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "bg-blue-50 rounded-lg p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-blue-600", children: platformStats.totalTipsCount || "0" }),
            /* @__PURE__ */ jsx("div", { className: "text-sm text-blue-600", children: "Total Tips" })
          ] }),
          /* @__PURE__ */ jsx(TrendingUp, { className: "w-8 h-8 text-blue-500" })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "bg-green-50 rounded-lg p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-green-600", children: creators.length }),
            /* @__PURE__ */ jsx("div", { className: "text-sm text-green-600", children: "Active Creators" })
          ] }),
          /* @__PURE__ */ jsx(Users, { className: "w-8 h-8 text-green-500" })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "bg-purple-50 rounded-lg p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "text-sm text-purple-600", children: "Total Volume" })
          ] }),
          /* @__PURE__ */ jsx(Wallet, { className: "w-8 h-8 text-purple-500" })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "bg-orange-50 rounded-lg p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "text-sm text-orange-600", children: "Platform Fees" })
          ] }),
          /* @__PURE__ */ jsx(Gift2, { className: "w-8 h-8 text-orange-500" })
        ] }) })
      ] }) : /* @__PURE__ */ jsxs("div", { className: "text-center py-8 text-gray-500", children: [
        /* @__PURE__ */ jsx(Activity, { className: "w-12 h-12 mx-auto mb-4 text-gray-400" }),
        /* @__PURE__ */ jsx("p", { children: "Platform statistics not available" })
      ] })
    ] }),
    message && /* @__PURE__ */ jsx("div", { className: `rounded-lg p-4 border ${message.type === "success" ? "bg-green-50 border-green-200 text-green-800" : message.type === "error" ? "bg-red-50 border-red-200 text-red-800" : message.type === "warning" ? "bg-yellow-50 border-yellow-200 text-yellow-800" : "bg-blue-50 border-blue-200 text-blue-800"}`, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
        message.type === "success" && /* @__PURE__ */ jsx(CheckCircle, { className: "w-4 h-4 mr-2" }),
        message.type === "error" && /* @__PURE__ */ jsx(XCircle, { className: "w-4 h-4 mr-2" }),
        message.type === "warning" && /* @__PURE__ */ jsx(AlertCircle, { className: "w-4 h-4 mr-2" }),
        message.type === "info" && /* @__PURE__ */ jsx(AlertCircle, { className: "w-4 h-4 mr-2" }),
    ...
    isOwnerOrAdmin && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg p-6 shadow-sm border", children: [
      /* @__PURE__ */ jsxs("h2", { className: "text-lg font-semibold text-gray-900 mb-4 flex items-center", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "md:col-span-2", children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Creator Wallet Address" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Membership Tier" }),
          /* @__PURE__ */ jsx(
            "select",
            {
              ...
              className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent",
              disabled: loading,
              children: Object.entries(TIER_INFO).map(([tier, info]) => /* @__PURE__ */ jsxs("option", { value: tier, children: [
                info.name,
                " (",
                info.split,
                ")"
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600", children: [
          /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Selected Tier:" }),
          " ",
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              loading ? /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 animate-spin mr-2" }) : /* @__PURE__ */ jsx(Plus, { className: "w-4 h-4 mr-2" }),
              "Add Creator"
            ]
          }
        )
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg p-6 shadow-sm border", children: [
      /* @__PURE__ */ jsxs("h2", { className: "text-lg font-semibold text-gray-900 mb-4 flex items-center", children: [
        /* @__PURE__ */ jsx(Users, { className: "w-5 h-5 mr-2" }),
        "Creators (",
        creators.length,
        ")"
      ] }),
      loadingCreators ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center py-8", children: [
        /* @__PURE__ */ jsx(Loader2, { className: "w-6 h-6 animate-spin text-blue-600 mr-2" }),
        /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Loading creators..." })
      ] }) : creators.length > 0 ? /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full", children: [
        /* @__PURE__ */ jsx("thead", { className: "bg-gray-50", children: /* @__PURE__ */ jsxs("tr", { children: [
          /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "ID" }),
          /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Wallet" }),
          /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Tier" }),
          /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Status" }),
          /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Tips" }),
          /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Volume" })
        ] }) }),
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-200", children: creators.map((creator) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50", children: [
          /* @__PURE__ */ jsx("td", { className: "px-4 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsxs("span", { className: "text-sm font-medium text-gray-900", children: [
            "#",
            creator.id
          ] }) }),
          /* @__PURE__ */ jsx("td", { className: "px-4 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsxs("span", { className: "text-sm font-mono text-gray-600", children: [
            creator.wallet.slice(0, 6),
            "...",
            creator.wallet.slice(-4)
          ] }) }),
          /* @__PURE__ */ jsx("td", { className: "px-4 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx("span", { className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${TIER_INFO[creator.tier].color} text-gray-800`, children: TIER_INFO[creator.tier].name }) }),
          /* @__PURE__ */ jsx("td", { className: "px-4 py-4 whitespace-nowrap", children: creator.active ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center text-green-600", children: [
            /* @__PURE__ */ jsx(CheckCircle, { className: "w-4 h-4 mr-1" }),
            "Active"
          ] }) : /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center text-red-600", children: [
            /* @__PURE__ */ jsx(XCircle, { className: "w-4 h-4 mr-1" }),
            "Inactive"
          ] }) }),
          /* @__PURE__ */ jsx("td", { className: "px-4 py-4 whitespace-nowrap text-sm text-gray-900", children: creator.tipCount }),
          /* @__PURE__ */ jsxs("td", { className: "px-4 py-4 whitespace-nowrap text-sm text-gray-900", children: [
            "$",
        ...
        /* @__PURE__ */ jsx("p", { children: "No creators found" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm", children: "Add creators using the form above" })
      ] })
    ] })
  ] });
};
...
var ViewerRewardStats = ({
  ...
  const isDark = theme === "dark";
  const chainId = activeChain?.id || SUPPORTED_CHAINS$1.POLYGON;
...
var CreatorAnalyticsDashboard = ({
  ...
  const analytics = React14.useMemo(() => {
...
var StreamingPage = ({
  ...
  const renderCreatorAvatar = () => {
    ...
    return /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "text-2xl font-bold text-white", children: creatorName.split(" ").map((n) => n[0]).join("").slice(0, 2) }) });
  };
  const renderAccessControlAlert = () => {
    if (!account) {
      return /* @__PURE__ */ jsx("div", { className: "mb-6 bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex", children: [
          /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(DollarSign, { className: "h-5 w-5 text-yellow-400" }) }),
          /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-yellow-700", children: [
              /* @__PURE__ */ jsx("strong", { children: "Connect Wallet:" }),
              " Connect your wallet to tip this creator"
            ] }),
            demoTipperWallet && /* @__PURE__ */ jsxs("p", { className: "text-xs text-yellow-600 mt-1 font-mono", children: [
              "Demo Tipper: ",
              demoTipperWallet
            ] })
          ] })
    ...
    if (allowedTippers.length > 0 && !isAuthorizedTipper) {
      return /* @__PURE__ */ jsx("div", { className: "mb-6 bg-orange-100 border-l-4 border-orange-500 p-4 rounded", children: /* @__PURE__ */ jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(DollarSign, { className: "h-5 w-5 text-orange-400" }) }),
        /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-xs text-orange-600 mt-1", children: [
            "Expected: ",
            /* @__PURE__ */ jsx("span", { className: "font-mono", children: allowedTippers[0] })
          ] }),
          /* @__PURE__ */ jsxs("p", { className: "text-xs text-orange-600", children: [
            "Connected: ",
            /* @__PURE__ */ jsx("span", { className: "font-mono", children: account.address })
          ] })
        ] })
      ] }) });
    }
    if (isAuthorizedTipper) {
      return /* @__PURE__ */ jsx("div", { className: "mb-6 bg-green-100 border-l-4 border-green-500 p-4 rounded", children: /* @__PURE__ */ jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(DollarSign, { className: "h-5 w-5 text-green-400" }) }),
        /* @__PURE__ */ jsx("div", { className: "ml-3", children: /* @__PURE__ */ jsxs("p", { className: "text-sm text-green-700", children: [
          /* @__PURE__ */ jsx("strong", { children: "Ready to Tip!" }),
  ...
  const renderTipMessage = () => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: `mt-6 p-4 rounded-lg border flex items-center space-x-3 ${tipMessage.type === "success" ? "bg-green-50 border-green-200 text-green-800" : tipMessage.type === "error" ? "bg-red-50 border-red-200 text-red-800" : tipMessage.type === "warning" ? "bg-yellow-50 border-yellow-200 text-yellow-800" : "bg-blue-50 border-blue-200 text-blue-800"}`, children: [
      tipMessage.type === "success" ? /* @__PURE__ */ jsx(CheckCircle, { className: "w-5 h-5 flex-shrink-0" }) : /* @__PURE__ */ jsx(AlertCircle, { className: "w-5 h-5 flex-shrink-0" }),
      /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsx("p", { className: "font-medium", children: tipMessage.text }),
        tipMessage.result && tipMessage.result.estimatedUsdcAmount && /* @__PURE__ */ jsxs("p", { className: "text-sm mt-1", children: [
  ...
  return /* @__PURE__ */ jsx("div", { className: `min-h-screen bg-gray-900 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 py-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-300", children: streamDescription })
    ] }),
    renderAccessControlAlert(),
    /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: `bg-black rounded-lg overflow-hidden shadow-2xl ${streamPlayerClassName}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "relative aspect-video bg-gradient-to-br from-purple-900 to-blue-900 flex items-center justify-center", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-black bg-opacity-30" }),
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "w-32 h-32 mx-auto mb-4", children: renderCreatorAvatar() }),
            /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-white mb-2", children: creatorName }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-300 mb-4", children: streamDescription }),
            enableVideoControls && /* @__PURE__ */ jsx(
              "button",
              {
                onClick: handlePlayPause,
                className: "bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full p-4 transition-all duration-200",
                children: isPlaying ? /* @__PURE__ */ jsx(Pause, { className: "w-8 h-8 text-white" }) : /* @__PURE__ */ jsx(Play, { className: "w-8 h-8 text-white ml-1" })
              }
            )
          ] }),
          isLiveStream && /* @__PURE__ */ jsxs("div", { className: "absolute top-4 left-4 bg-red-600 text-white px-3 py-1 rounded-full text-sm font-semibold flex items-center", children: [
            /* @__PURE__ */ jsx("div", { className: "w-2 h-2 bg-white rounded-full mr-2 animate-pulse" }),
            "LIVE"
          ] }),
          enableViewerCount && /* @__PURE__ */ jsxs("div", { className: "absolute top-4 right-4 bg-black bg-opacity-50 text-white px-3 py-1 rounded-full text-sm flex items-center", children: [
            /* @__PURE__ */ jsx(Eye, { className: "w-4 h-4 mr-1" }),
            viewerCount.toLocaleString()
          ] }),
          enableVideoControls && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-4 right-4 flex items-center space-x-2", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-gray-800 text-white p-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("div", { className: "flex items-center space-x-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10", children: renderCreatorAvatar() }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h4", { className: "font-semibold", children: creatorName }),
                /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-400 font-mono", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-4", children: [
              enableLikeButton && /* @__PURE__ */ jsxs(
                "button",
                {
                  onClick: handleLikeToggle,
                  className: `flex items-center transition-colors ${isLiked ? "text-red-500" : "text-gray-300 hover:text-red-400"}`,
                  children: [
                    /* @__PURE__ */ jsx(Heart, { className: `w-4 h-4 mr-1 ${isLiked ? "fill-current" : ""}` }),
                    /* @__PURE__ */ jsx("span", { className: "text-sm", children: likeCount })
                  ]
                }
              ),
              enableViewerCount && /* @__PURE__ */ jsxs("div", { className: "flex items-center text-gray-300", children: [
                /* @__PURE__ */ jsx(Users, { className: "w-4 h-4 mr-1" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm", children: viewerCount })
              ] }),
              enableShareButton && /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: handleShare,
              ...
              /* @__PURE__ */ jsx("button", { className: "flex items-center text-gray-300 hover:text-white transition-colors", children: /* @__PURE__ */ jsx(MoreVertical, { className: "w-4 h-4" }) })
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-300", children: "\u{1F680} Live demo of TippingChain v2.0 - Multi-chain tipping with USDC payouts on ApeChain" }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxs("div", { className: `bg-white rounded-lg shadow-lg p-6 ${tippingPanelClassName}`, children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold mb-4 text-gray-900", children: "\u{1F4B0} Send Tip to Creator" }),
        /* @__PURE__ */ jsxs("div", { className: "mb-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-semibold text-gray-900 mb-2", children: "Target Creator" }),
          /* @__PURE__ */ jsxs("div", { className: "text-sm space-y-1", children: [
            /* @__PURE__ */ jsxs("p", { className: "text-gray-600", children: [
              "Creator ID: ",
              /* @__PURE__ */ jsxs("span", { className: "font-mono bg-gray-100 px-2 py-1 rounded", children: [
                "#",
                creatorId
              ] })
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "text-gray-600", children: [
              "Name: ",
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: creatorName })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Wallet:" }),
            /* @__PURE__ */ jsx("p", { className: "font-mono text-xs bg-gray-100 p-2 rounded break-all", children: creatorWallet }),
            /* @__PURE__ */ jsx("p", { className: "text-green-600 text-xs", children: "\u2713 Registered & Active" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
          ...
          selectedChainId && /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500 mt-2", children: [
            "Connected to: ",
            activeChain?.name || "Not connected"
          ] })
        ] }),
        isAuthorizedTipper ? /* @__PURE__ */ jsx(
        ...
        ) : /* @__PURE__ */ jsxs("div", { className: "p-6 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 text-center", children: [
          /* @__PURE__ */ jsx(DollarSign, { className: "w-12 h-12 text-gray-400 mx-auto mb-3" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600 font-medium mb-2", children: "Multi-Token Tipping Interface Locked" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: allowedTippers.length > 0 ? "Connect with an authorized wallet to unlock tipping functionality" : "Connect your wallet to unlock tipping functionality" })
        ] }),
        renderTipMessage()
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-12 bg-white rounded-xl shadow-lg p-8", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-center text-gray-900 mb-8", children: "How TippingChain Works" }),
      /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-3 gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          ...
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-2", children: "Choose Your Token" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Tip with native tokens or ERC20s (USDC, DAI, WETH) on 9 supported blockchains - see real-time balances and token info" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx("span", { className: "text-2xl font-bold text-purple-600", children: "2" }) }),
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-2", children: "Auto Cross-Chain Bridge" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Integrated Relay.link automatically bridges your tip and converts it to stable USDC - no extra steps needed" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx("span", { className: "text-2xl font-bold text-green-600", children: "3" }) }),
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-2", children: "Creator Gets Paid" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Creator receives stable USDC on ApeChain after 5% platform fee and tier-based revenue sharing" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mt-8 pt-6 border-t border-gray-200", children: [
        /* @__PURE__ */ jsx("h3", { className: "font-semibold text-gray-900 mb-3", children: "Stream Configuration" }),
        /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 rounded-lg p-4 space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Creator:" }),
            /* @__PURE__ */ jsxs("span", { className: "font-mono text-gray-900", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Creator ID:" }),
            /* @__PURE__ */ jsxs("span", { className: "font-mono text-gray-900", children: [
              "#",
              creatorId
            ] })
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Stream Type:" }),
            /* @__PURE__ */ jsx("span", { className: "text-gray-900", children: isLiveStream ? "Live Stream" : "Video" })
          ] }),
          enableViewerCount && /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Current Viewers:" }),
            /* @__PURE__ */ jsx("span", { className: "text-gray-900", children: viewerCount.toLocaleString() })
          ] })
        ] })
      ] })
    ] })
...
var AdminDashboard = ({
  ...
  const handleCreatorAdded = useCallback((creator) => {
  ...
  const handleCreatorUpdated = useCallback((creator) => {
  ...
  const handleSystemSettingChange = useCallback((settingKey, newValue) => {
  ...
  if (requirePermissionCheck && !account) {
    return /* @__PURE__ */ jsx("div", { className: `min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-lg p-8 text-center max-w-md", children: [
      /* @__PURE__ */ jsx(Shield, { className: "w-16 h-16 text-blue-600 mx-auto mb-4" }),
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-gray-900 mb-2", children: "Admin Access Required" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600 mb-6", children: "Connect your wallet to access the TippingChain admin dashboard" }),
      /* @__PURE__ */ jsx(ConnectButton, { client, theme: "light" })
    ] }) });
  }
  if (requirePermissionCheck && !hasAdminAccess && !permissionLoading) {
    return /* @__PURE__ */ jsx("div", { className: `min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-lg p-8 text-center max-w-md", children: [
      /* @__PURE__ */ jsx(AlertCircle, { className: "w-16 h-16 text-red-600 mx-auto mb-4" }),
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-gray-900 mb-2", children: "Access Denied" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600 mb-4", children: "You don't have permission to access the admin dashboard" }),
  ...
  const renderOverview = () => /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    dashboardStats && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-sm p-6 border-l-4 border-blue-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Total Creators" }),
          /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-gray-900", children: dashboardStats.totalCreators }),
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-sm p-6 border-l-4 border-green-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Total Volume" }),
        ...
        /* @__PURE__ */ jsx(DollarSign, { className: "w-8 h-8 text-green-600" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-sm p-6 border-l-4 border-purple-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Platform Fees" }),
          /* @__PURE__ */ jsxs("p", { className: "text-2xl font-bold text-gray-900", children: [
            formatAmount(dashboardStats.platformFees),
            " ETH"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-purple-600", children: "5% fee rate" })
        ] }),
        /* @__PURE__ */ jsx(Activity, { className: "w-8 h-8 text-purple-600" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-sm p-6 border-l-4 border-orange-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "System Health" }),
          /* @__PURE__ */ jsx("p", { className: `text-2xl font-bold ${dashboardStats.systemHealth === "healthy" ? "text-green-600" : dashboardStats.systemHealth === "warning" ? "text-yellow-600" : "text-red-600"}`, children: dashboardStats.systemHealth === "healthy" ? "\u2713 Healthy" : dashboardStats.systemHealth === "warning" ? "\u26A0 Warning" : "\u2717 Error" }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-600", children: [
            dashboardStats.recentActivity,
            " transactions"
          ] })
        ] }),
        /* @__PURE__ */ jsx(CheckCircle, { className: "w-8 h-8 text-orange-600" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-sm p-6", children: [
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-4", children: "Quick Actions" }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(Plus, { className: "w-6 h-6 text-blue-600 mr-3" }),
              /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
                /* @__PURE__ */ jsx("div", { className: "font-medium", children: "Add Creator" }),
                /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500", children: "Register new creator" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(RefreshCw, { className: "w-6 h-6 text-green-600 mr-3" }),
              /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
                /* @__PURE__ */ jsx("div", { className: "font-medium", children: "Refresh Data" }),
                /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500", children: "Update statistics" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(BarChart3, { className: "w-6 h-6 text-purple-600 mr-3" }),
              /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
                /* @__PURE__ */ jsx("div", { className: "font-medium", children: "View Analytics" }),
                /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500", children: "Detailed insights" })
              ] })
            ]
          }
        )
  ...
  const renderSettings = () => /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-sm p-6", children: [
    /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-6", children: "System Settings" }),
    Object.entries(
    ...
    ).map(([category, settings]) => /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxs("h4", { className: "text-md font-medium text-gray-900 mb-4 capitalize", children: [
        category,
        " Settings"
      ] }),
      /* @__PURE__ */ jsx("div", { className: "space-y-4", children: settings.map((setting) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 bg-gray-50 rounded-lg", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-900", children: setting.label }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: setting.description })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "ml-4", children: setting.type === "boolean" ? /* @__PURE__ */ jsx(
          "button",
          {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 ${className}`, children: [
    showHeader && /* @__PURE__ */ jsx("div", { className: `bg-white shadow-sm border-b ${headerClassName}`, children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-4", children: [
        /* @__PURE__ */ jsx(Shield, { className: "w-8 h-8 text-blue-600" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "TippingChain Admin" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600", children: "Multi-chain creator platform administration" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-4", children: [
        allowMultiChain && /* @__PURE__ */ jsx(
          ChainSelector,
          {
            value: selectedChainId,
            onChange: setSelectedChainId,
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            title: "Refresh data",
            children: /* @__PURE__ */ jsx(RefreshCw, { className: `w-5 h-5 ${loading ? "animate-spin" : ""}` })
          }
        ),
        account && /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-medium text-gray-900", children: hasOwnerAccess ? "Owner" : hasAdminAccess ? "Admin" : "User" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex", children: [
      showSidebar && /* @__PURE__ */ jsx("div", { className: `w-64 bg-white shadow-sm ${sidebarClassName}`, children: /* @__PURE__ */ jsx("div", { className: "p-4", children: /* @__PURE__ */ jsx("nav", { className: "space-y-2", children: sidebarItems.map((item) => /* @__PURE__ */ jsxs(
        "button",
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: `flex-1 p-6 ${contentClassName}`, children: [
        activeView === "overview" && renderOverview(),
        activeView === "creators" && /* @__PURE__ */ jsx(
          AdminInterface,
          {
            client,
            sdk,
        ...
        activeView === "analytics" && enableCreatorAnalytics && /* @__PURE__ */ jsx(
...
var AnalyticsDashboard = ({
  ...
  const [chainAnalytics, setChainAnalytics] = useState({});
  const [globalLoading, setGlobalLoading] = useState(false);
  const [showAdvancedFilters, setShowAdvancedFilters] = useState(false);
  const [autoRefresh, setAutoRefresh] = useState(enableRealTimeUpdates);
  const [refreshInterval, setRefreshInterval] = useState(null);
  const [creatorFilter, setCreatorFilter] = useState("all");
  const [minimumTipAmount, setMinimumTipAmount] = useState(0);
  const [sortBy, setSortBy] = useState("volume");
  useEffect(() => {
    const supportedChainIds = Object.values(SUPPORTED_CHAINS).filter((id) => typeof id === "number");
  ...
  const mapCreatorToAnalytics = useCallback((creator) => {
    const avgTip = creator.tipCount > 0 ? parseFloat(creator.totalTips) / creator.tipCount : 0;
    return {
      id: creator.id,
      wallet: creator.wallet,
  ...
  const mapPlatformToAnalytics = useCallback((stats, viewerRewardsStats, creators) => {
  ...
  const handleCreatorSelect = useCallback((creatorId) => {
  ...
  const globalMetrics = React14.useMemo(() => {
  ...
  return /* @__PURE__ */ jsx("div", { className: `min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 space-y-8", children: [
    /* @__PURE__ */ jsxs("div", { className: `text-center ${headerClassName}`, children: [
      /* @__PURE__ */ jsxs("h1", { className: "text-4xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-3", children: [
        /* @__PURE__ */ jsx(BarChart3, { className: "w-10 h-10 text-blue-600" }),
        "Advanced Creator Analytics"
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-600 mb-6", children: "Comprehensive insights and performance metrics for TippingChain creators" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-4 mb-6 flex-wrap", children: [
        /* @__PURE__ */ jsx(
          "select",
          {
            ...
            children: Object.entries(TIME_RANGES).map(([key, range]) => /* @__PURE__ */ jsx("option", { value: key, children: range.label }, key))
          }
        ),
        enableRealTimeUpdates && /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(RefreshCw, { className: `w-4 h-4 mr-2 ${autoRefresh ? "animate-spin" : ""}` }),
              "Auto Refresh ",
              autoRefresh ? "On" : "Off"
            ]
          }
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              globalLoading ? /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 mr-2 animate-spin" }) : /* @__PURE__ */ jsx(TrendingUp, { className: "w-4 h-4 mr-2" }),
              globalLoading ? "Loading Analytics..." : "Refresh All Analytics"
            ]
          }
        ),
        enableDataExport && currentChainData && /* @__PURE__ */ jsxs(
          "button",
          {
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(Filter, { className: "w-4 h-4 mr-2" }),
              "Filters ",
              showAdvancedFilters ? /* @__PURE__ */ jsx(EyeOff, { className: "w-4 h-4 ml-1" }) : /* @__PURE__ */ jsx(Eye, { className: "w-4 h-4 ml-1" })
            ]
          }
        ),
        !account && /* @__PURE__ */ jsx(ConnectButton, { client, theme: "light" })
      ] }),
      showAdvancedFilters && /* @__PURE__ */ jsx("div", { className: "bg-white rounded-lg shadow-sm p-6 mb-6", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Creator Filter" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              value: creatorFilter,
              ...
              className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent",
              children: [
                /* @__PURE__ */ jsx("option", { value: "all", children: "All Creators" }),
                /* @__PURE__ */ jsx("option", { value: "active", children: "Active Only" }),
                /* @__PURE__ */ jsx("option", { value: "inactive", children: "Inactive Only" }),
                /* @__PURE__ */ jsx("option", { value: "top-performers", children: "Top Performers" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Min Tip Amount (ETH)" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Sort By" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              value: sortBy,
              ...
              className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent",
              children: [
                /* @__PURE__ */ jsx("option", { value: "volume", children: "Total Volume" }),
                /* @__PURE__ */ jsx("option", { value: "count", children: "Tip Count" }),
                /* @__PURE__ */ jsx("option", { value: "average", children: "Average Tip" }),
                /* @__PURE__ */ jsx("option", { value: "recent", children: "Most Recent" })
              ]
    ...
    enableGlobalMetrics && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Total Platform Volume" }),
          /* @__PURE__ */ jsxs("p", { className: "text-2xl font-bold text-gray-900", children: [
        ...
        /* @__PURE__ */ jsx(Globe, { className: "w-8 h-8 text-blue-600" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Total Creators" }),
          /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-gray-900", children: globalMetrics.totalCreators.toLocaleString() }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500", children: [
            globalMetrics.activeCreators,
            " active"
          ] })
        ] }),
        /* @__PURE__ */ jsx(Users, { className: "w-8 h-8 text-green-600" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Total Transactions" }),
          /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-gray-900", children: globalMetrics.totalTransactions.toLocaleString() }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "All tip transactions" })
        ] }),
        /* @__PURE__ */ jsx(TrendingUp, { className: "w-8 h-8 text-purple-600" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Platform Growth" }),
          /* @__PURE__ */ jsxs("p", { className: "text-2xl font-bold text-gray-900", children: [
            "+",
            globalMetrics.averageGrowthRate.toFixed(1),
            "%"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: TIME_RANGES[selectedTimeRange].label })
        ] }),
        /* @__PURE__ */ jsx(Activity, { className: "w-8 h-8 text-orange-600" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-lg p-6 border-l-4 border-yellow-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Top Chain" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-gray-900", children: globalMetrics.topPerformingChain }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "Highest volume" })
        ] }),
        /* @__PURE__ */ jsx(Award, { className: "w-8 h-8 text-yellow-600" })
      ] }) })
    ] }),
    enableMultiChain && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6", children: [
      /* @__PURE__ */ jsxs("h2", { className: "text-xl font-semibold text-gray-900 mb-4 flex items-center", children: [
        /* @__PURE__ */ jsx(Globe, { className: "w-5 h-5 mr-2" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "max-w-md", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 mt-2", children: "Choose a blockchain to view detailed creator performance metrics" })
        ] }),
        currentChainData?.lastUpdated && /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-500 flex items-center", children: [
    ...
    currentChainData && /* @__PURE__ */ jsx("div", { className: contentClassName, children: /* @__PURE__ */ jsx(
      CreatorAnalyticsDashboard,
      {
    ...
    enableChainComparison && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6", children: [
      /* @__PURE__ */ jsxs("h2", { className: "text-xl font-semibold text-gray-900 mb-6 flex items-center", children: [
        /* @__PURE__ */ jsx(Globe, { className: "w-5 h-5 mr-2" }),
        "Multi-Chain Performance Comparison"
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: deployedChains.map((chain) => {
        ...
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
                /* @__PURE__ */ jsx("h3", { className: "font-semibold text-gray-900", children: chain.chainName }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-1", children: [
                  chain.loading && /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 animate-spin text-blue-600" }),
                  chain.chainId === selectedChainId && /* @__PURE__ */ jsx(CheckCircle, { className: "w-4 h-4 text-blue-600" })
                ] })
              ] }),
              chain.error ? /* @__PURE__ */ jsxs("div", { className: "flex items-center text-red-500 text-sm", children: [
                /* @__PURE__ */ jsx(AlertCircle, { className: "w-4 h-4 mr-1" }),
                /* @__PURE__ */ jsx("span", { children: "Error loading data" })
              ] }) : chain.platformStats ? /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-sm", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Volume:" }),
                  /* @__PURE__ */ jsxs("span", { className: "font-medium", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Active Creators:" }),
                  /* @__PURE__ */ jsxs("span", { className: "font-medium", children: [
                    activeCreators,
                    "/",
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Transactions:" }),
                  /* @__PURE__ */ jsx("span", { className: "font-medium", children: chain.platformStats.totalCount })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Growth:" }),
              ...
              ] }) : /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-sm", children: "Click to load analytics" })
            ]
          },
          chain.chainId
        );
...
var ViewerRewardsPage = ({
  ...
  const renderMessage = () => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: `mb-6 p-4 rounded-lg border flex items-center justify-between ${message.type === "success" ? "bg-green-50 border-green-200 text-green-800" : message.type === "error" ? "bg-red-50 border-red-200 text-red-800" : "bg-blue-50 border-blue-200 text-blue-800"}`, children: [
      /* @__PURE__ */ jsx("span", { children: message.text }),
      /* @__PURE__ */ jsx(
        "button",
        {
  ...
  const renderStatsCards = () => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8", children: [
    /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-sm p-6 border-l-4 border-green-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Total Allocated" }),
        /* @__PURE__ */ jsxs("p", { className: "text-2xl font-bold text-gray-900", children: [
          "$",
          rewardStats.totalAllocated.toFixed(2)
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-green-600", children: "USDC distributed" })
      ] }),
      /* @__PURE__ */ jsx(DollarSign, { className: "w-8 h-8 text-green-600" })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-sm p-6 border-l-4 border-blue-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Active Viewers" }),
        /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-gray-900", children: rewardStats.uniqueViewers }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-blue-600", children: "Registered users" })
      ] }),
      /* @__PURE__ */ jsx(Users, { className: "w-8 h-8 text-blue-600" })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-sm p-6 border-l-4 border-purple-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Average Reward" }),
        /* @__PURE__ */ jsxs("p", { className: "text-2xl font-bold text-gray-900", children: [
          "$",
          rewardStats.averageReward.toFixed(2)
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-purple-600", children: "Per viewer" })
      ] }),
      /* @__PURE__ */ jsx(Award, { className: "w-8 h-8 text-purple-600" })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-sm p-6 border-l-4 border-orange-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Platform Fees" }),
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm text-orange-600", children: "1% fee collected" })
      ] }),
      /* @__PURE__ */ jsx(TrendingUp, { className: "w-8 h-8 text-orange-600" })
    ] }) })
  ] });
  const tabs = [
  ...
  return /* @__PURE__ */ jsx("div", { className: `min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 py-8 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxs("div", { className: `text-center mb-8 ${headerClassName}`, children: [
      /* @__PURE__ */ jsxs("h1", { className: "text-4xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-3", children: [
        /* @__PURE__ */ jsx(Award, { className: "w-10 h-10 text-purple-600" }),
        "Viewer Rewards Platform"
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-600", children: "Creators allocate funds to reward their audience - viewers can claim eligible rewards" })
    ] }),
    renderStatsCards(),
    renderMessage(),
    !account && /* @__PURE__ */ jsx("div", { className: "mb-6 bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(Award, { className: "h-5 w-5 text-yellow-400" }) }),
        /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-yellow-700", children: [
            /* @__PURE__ */ jsx("strong", { children: "Connect Wallet:" }),
            " Connect as creator to allocate rewards, or as viewer to claim"
          ] }),
          demoCreatorWallet && /* @__PURE__ */ jsxs("p", { className: "text-xs text-yellow-600 mt-1 font-mono", children: [
            "Demo Creator: ",
            demoCreatorWallet
          ] })
        ] })
    ...
    /* @__PURE__ */ jsx("div", { className: `mb-8 ${tabNavClassName}`, children: /* @__PURE__ */ jsx("div", { className: "border-b border-gray-200", children: /* @__PURE__ */ jsx("nav", { className: "-mb-px flex justify-center space-x-8", children: tabs.map((tab) => /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx(tab.icon, { className: "w-5 h-5 inline mr-2" }),
          tab.label
        ]
      },
      tab.id
    ...
    /* @__PURE__ */ jsxs("div", { className: contentClassName, children: [
      activeTab === "allocate" && enableBatchRewards && /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
        account && !isCreatorWallet && /* @__PURE__ */ jsx("div", { className: "bg-orange-100 border-l-4 border-orange-500 p-4 rounded", children: /* @__PURE__ */ jsxs("div", { className: "flex", children: [
          /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(X, { className: "h-5 w-5 text-orange-400" }) }),
          /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-orange-700", children: [
              /* @__PURE__ */ jsx("strong", { children: "Creator Access Required:" }),
              " Only registered creators can allocate rewards"
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "text-xs text-orange-600 mt-1", children: [
              "Expected: ",
              /* @__PURE__ */ jsx("span", { className: "font-mono", children: demoCreatorWallet })
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "text-xs text-orange-600", children: [
              "Connected: ",
              /* @__PURE__ */ jsx("span", { className: "font-mono", children: account.address })
        ...
        isCreatorWallet && /* @__PURE__ */ jsx("div", { className: "bg-green-100 border-l-4 border-green-500 p-4 rounded", children: /* @__PURE__ */ jsxs("div", { className: "flex", children: [
          /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(CheckCircle, { className: "h-5 w-5 text-green-400" }) }),
          /* @__PURE__ */ jsx("div", { className: "ml-3", children: /* @__PURE__ */ jsxs("p", { className: "text-sm text-green-700", children: [
            /* @__PURE__ */ jsx("strong", { children: "Creator Access Verified!" }),
            " You can allocate rewards to viewers"
          ] }) })
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-3 gap-8", children: [
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6", children: [
            /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-semibold mb-6 text-gray-900 flex items-center", children: [
              /* @__PURE__ */ jsx(DollarSign, { className: "w-6 h-6 mr-2 text-green-600" }),
              "Reward Allocation"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Total Allocation (USD)" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "number",
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 rounded-lg p-4 space-y-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Selected Viewers:" }),
                  /* @__PURE__ */ jsx("span", { className: "font-medium", children: selectedViewers.length })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Reward per Viewer:" }),
                  /* @__PURE__ */ jsxs("span", { className: "font-medium", children: [
                    "$",
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "Platform Fee (1%):" }),
                  /* @__PURE__ */ jsxs("span", { className: "font-medium", children: [
                    "$",
                    (allocationAmount * 0.01).toFixed(2)
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm font-semibold border-t pt-2", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                ...
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    children: [
                      loading ? /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 mr-2 animate-spin" }) : /* @__PURE__ */ jsx(Gift2, { className: "w-4 h-4 mr-2" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-6", children: [
              /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-semibold text-gray-900 flex items-center", children: [
                /* @__PURE__ */ jsx(Users, { className: "w-6 h-6 mr-2 text-blue-600" }),
                "Select Viewers to Reward"
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsx(Search, { className: "w-4 h-4 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "text",
                ...
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("option", { value: "all", children: "All Status" }),
                      /* @__PURE__ */ jsx("option", { value: "eligible", children: "Eligible" }),
                      /* @__PURE__ */ jsx("option", { value: "claimed", children: "Claimed" }),
                      /* @__PURE__ */ jsx("option", { value: "pending", children: "Pending" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    ...
                    className: "px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-sm",
                    children: [
                      /* @__PURE__ */ jsx("option", { value: "username", children: "Username" }),
                      /* @__PURE__ */ jsx("option", { value: "rewards", children: "Total Rewards" }),
                      /* @__PURE__ */ jsx("option", { value: "count", children: "Reward Count" }),
                      /* @__PURE__ */ jsx("option", { value: "date", children: "Last Reward" })
                    ]
                  }
                )
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-4", children: filteredViewers.map((viewer) => /* @__PURE__ */ jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-3", children: [
                    /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "text-white font-bold text-sm", children: viewer.username?.charAt(0) || "V" }) }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("p", { className: "font-medium text-gray-900", children: viewer.username }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end", children: [
                    /* @__PURE__ */ jsx("div", { className: `px-2 py-1 rounded-full text-xs font-medium ${viewer.status === "eligible" ? "bg-green-100 text-green-800" : viewer.status === "claimed" ? "bg-blue-100 text-blue-800" : viewer.status === "pending" ? "bg-yellow-100 text-yellow-800" : "bg-gray-100 text-gray-800"}`, children: viewer.status }),
                    selectedViewers.includes(viewer.id) && /* @__PURE__ */ jsx(CheckCircle, { className: "w-5 h-5 text-purple-600 mt-1" })
                  ] })
                ] })
              },
              viewer.id
      ...
      activeTab === "claim" && enableClaimInterface && /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-lg p-8", children: [
        /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-semibold mb-6 text-gray-900 text-center flex items-center justify-center", children: [
          /* @__PURE__ */ jsx(Gift2, { className: "w-6 h-6 mr-2 text-green-600" }),
          "Claim Your Rewards"
        ] }),
        !account ? /* @__PURE__ */ jsxs("div", { className: "text-center py-8", children: [
          /* @__PURE__ */ jsx(Award, { className: "w-16 h-16 text-gray-400 mx-auto mb-4" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600 mb-4", children: "Connect your wallet to check for available rewards" }),
          /* @__PURE__ */ jsx(ConnectButton, { client, theme: "light" })
        ] }) : userViewer ? /* @__PURE__ */ jsxs("div", { className: "text-center py-8", children: [
          /* @__PURE__ */ jsx("div", { className: "w-20 h-20 bg-gradient-to-r from-green-500 to-blue-500 rounded-full mx-auto mb-4 flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "text-white font-bold text-2xl", children: userViewer.username?.charAt(0) || "V" }) }),
          /* @__PURE__ */ jsxs("h3", { className: "text-xl font-semibold mb-2", children: [
            "Welcome, ",
            userViewer.username,
            "!"
          ] }),
          /* @__PURE__ */ jsx("div", { className: "bg-gray-50 rounded-lg p-6 mt-4 text-left", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "Total Earned" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-blue-600", children: userViewer.rewardCount || 0 }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "Rewards Received" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-purple-600 capitalize", children: userViewer.status }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "Current Status" })
            ] })
          ] }) }),
          userViewer.status === "eligible" && /* @__PURE__ */ jsxs("div", { className: "bg-green-50 border border-green-200 rounded-lg p-6 mt-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center mb-4", children: [
              /* @__PURE__ */ jsx(Gift2, { className: "w-8 h-8 text-green-600 mr-2" }),
              /* @__PURE__ */ jsx("span", { className: "text-lg font-semibold text-green-800", children: "Reward Available!" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-green-700 mb-4", children: "You have an unclaimed reward waiting for you" }),
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  loading ? /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 mr-2 animate-spin" }) : /* @__PURE__ */ jsx(CheckCircle, { className: "w-4 h-4 mr-2" }),
                  loading ? "Processing..." : "Claim Reward"
                ]
              }
            )
          ] }),
          userViewer.status === "claimed" && /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-lg p-6 mt-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center mb-2", children: [
              /* @__PURE__ */ jsx(CheckCircle, { className: "w-8 h-8 text-blue-600 mr-2" }),
              /* @__PURE__ */ jsx("span", { className: "text-lg font-semibold text-blue-800", children: "Already Claimed" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-blue-700", children: "You have successfully claimed your reward. USDC has been sent to your wallet on ApeChain." }),
            userViewer.lastRewardDate && /* @__PURE__ */ jsxs("p", { className: "text-sm text-blue-600 mt-2", children: [
              "Last claimed: ",
              userViewer.lastRewardDate.toLocaleString()
            ] })
          ] }),
          userViewer.status === "pending" && /* @__PURE__ */ jsxs("div", { className: "bg-yellow-50 border border-yellow-200 rounded-lg p-6 mt-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center mb-2", children: [
              /* @__PURE__ */ jsx(Clock, { className: "w-8 h-8 text-yellow-600 mr-2" }),
              /* @__PURE__ */ jsx("span", { className: "text-lg font-semibold text-yellow-800", children: "Processing" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-yellow-700", children: "Your reward is being processed. Please check back soon." })
          ] })
        ] }) : /* @__PURE__ */ jsxs("div", { className: "text-center py-8", children: [
          /* @__PURE__ */ jsx(Eye, { className: "w-16 h-16 text-gray-400 mx-auto mb-4" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Your wallet is not registered as a viewer in this system." }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500 mt-2 font-mono", children: [
            "Connected: ",
            account.address
          ] }),
          enableViewerRegistration && /* @__PURE__ */ jsx(
            "button",
            {
      ...
      activeTab === "history" && enableRewardHistory && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6", children: [
        /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-semibold mb-6 text-gray-900 flex items-center", children: [
          /* @__PURE__ */ jsx(Clock, { className: "w-6 h-6 mr-2 text-blue-600" }),
          "Reward Transaction History"
        ] }),
        rewardHistory.length > 0 ? /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full", children: [
          /* @__PURE__ */ jsx("thead", { className: "bg-gray-50", children: /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Date" }),
            /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Creator" }),
            /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Recipients" }),
            /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Amount" }),
            /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Status" }),
            /* @__PURE__ */ jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Transaction" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-200", children: rewardHistory.map((tx) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50", children: [
            /* @__PURE__ */ jsx("td", { className: "px-4 py-4 whitespace-nowrap text-sm text-gray-900", children: tx.timestamp.toLocaleDateString() }),
            /* @__PURE__ */ jsx("td", { className: "px-4 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsxs("span", { className: "text-sm font-mono text-gray-600", children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "px-4 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx("span", { className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${tx.status === "completed" ? "bg-green-100 text-green-800" : tx.status === "pending" ? "bg-yellow-100 text-yellow-800" : "bg-red-100 text-red-800"}`, children: tx.status }) }),
            /* @__PURE__ */ jsx("td", { className: "px-4 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsxs("span", { className: "text-sm font-mono text-gray-600", children: [
          ...
          /* @__PURE__ */ jsx(Clock, { className: "w-12 h-12 text-gray-400 mx-auto mb-4" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "No reward transactions yet" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "Transaction history will appear here after rewards are sent" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-12 bg-white rounded-xl shadow-lg p-8", children: [
      /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-4 text-gray-900", children: "How Viewer Rewards Work" }),
      /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h4", { className: "font-medium mb-2 text-purple-600", children: "For Creators:" }),
          /* @__PURE__ */ jsxs("ul", { className: "space-y-1 text-sm text-gray-600", children: [
            /* @__PURE__ */ jsx("li", { children: "\u2022 Allocate a total reward amount (e.g., $100)" }),
            /* @__PURE__ */ jsx("li", { children: "\u2022 Select eligible viewers from your audience" }),
            /* @__PURE__ */ jsx("li", { children: "\u2022 Funds are split equally among selected viewers" }),
            /* @__PURE__ */ jsx("li", { children: "\u2022 Only 1% platform fee (vs 5% for regular tips)" }),
            /* @__PURE__ */ jsx("li", { children: "\u2022 All rewards auto-convert to USDC on ApeChain" }),
            /* @__PURE__ */ jsx("li", { children: "\u2022 Track reward history and viewer engagement" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h4", { className: "font-medium mb-2 text-green-600", children: "For Viewers:" }),
          /* @__PURE__ */ jsxs("ul", { className: "space-y-1 text-sm text-gray-600", children: [
            /* @__PURE__ */ jsx("li", { children: "\u2022 Register to become eligible for rewards" }),
            /* @__PURE__ */ jsx("li", { children: "\u2022 Check if you have eligible rewards to claim" }),
            /* @__PURE__ */ jsx("li", { children: '\u2022 Click "Claim Reward" to receive your USDC' }),
            /* @__PURE__ */ jsx("li", { children: "\u2022 Funds are sent directly to your wallet on ApeChain" }),
            /* @__PURE__ */ jsx("li", { children: "\u2022 No gas fees for claiming rewards" }),
            /* @__PURE__ */ jsx("li", { children: "\u2022 Stable USDC payouts for price protection" })
          ] })
        ] })
      ] })
    ] })
...
var TransactionHistoryPage = ({
  ...
  const renderStatsCards = () => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 ${statsCardClassName}`, children: [
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Total Volume" }),
          /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-gray-900", children: formatCurrency(stats.totalVolumeUsd) }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-green-600", children: "Lifetime transactions" })
        ] }),
        /* @__PURE__ */ jsx(TrendingUp, { className: "w-8 h-8 text-green-600" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Success Rate" }),
          /* @__PURE__ */ jsxs("p", { className: "text-2xl font-bold text-gray-900", children: [
            stats.totalTransactions > 0 ? Math.round(stats.successfulTransactions / stats.totalTransactions * 100) : 0,
            "%"
          ] }),
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-blue-600", children: [
            stats.successfulTransactions,
            " successful"
          ] })
        ] }),
        /* @__PURE__ */ jsx(BarChart3, { className: "w-8 h-8 text-blue-600" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Creators Supported" }),
          /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-gray-900", children: stats.uniqueCreatorsTipped }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-purple-600", children: "Unique creators" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "text-3xl", children: "\u{1F465}" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-gray-600", children: "Platform Fees" }),
          /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-gray-900", children: formatCurrency(stats.totalFeesUsd) }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-orange-600", children: "Fees contributed" })
        ] }),
        /* @__PURE__ */ jsx(DollarSign, { className: "w-8 h-8 text-orange-600" })
      ] }) })
    ] });
  };
  const renderFilters = () => {
    if (!enableFiltering) return null;
    return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-sm p-6 mb-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900", children: "Filters & Search" }),
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(Filter, { className: "w-4 h-4 mr-2" }),
              showFilters ? /* @__PURE__ */ jsx(EyeOff, { className: "w-4 h-4 ml-1" }) : /* @__PURE__ */ jsx(Eye, { className: "w-4 h-4 ml-1" })
            ]
          }
        )
      ] }),
      showFilters && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(Search, { className: "w-4 h-4 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" }),
            /* @__PURE__ */ jsx(
          ...
          /* @__PURE__ */ jsxs(
            "select",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("option", { value: "7d", children: "Last 7 Days" }),
                /* @__PURE__ */ jsx("option", { value: "30d", children: "Last 30 Days" }),
                /* @__PURE__ */ jsx("option", { value: "90d", children: "Last 90 Days" }),
                /* @__PURE__ */ jsx("option", { value: "all", children: "All Time" })
              ]
            }
          )
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
          /* @__PURE__ */ jsxs(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("option", { value: "all", children: "All Status" }),
                /* @__PURE__ */ jsx("option", { value: "success", children: "Successful" }),
                /* @__PURE__ */ jsx("option", { value: "pending", children: "Pending" }),
                /* @__PURE__ */ jsx("option", { value: "failed", children: "Failed" })
              ]
            }
  ...
  const renderExportSection = () => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-sm p-6 mb-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-3", children: [
          /* @__PURE__ */ jsx(Download, { className: "w-6 h-6 text-blue-600" }),
          /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-gray-900", children: "Export Transaction History" })
        ] }),
        lastRefreshTime && /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-500 flex items-center", children: [
          /* @__PURE__ */ jsx(Clock, { className: "w-4 h-4 mr-1" }),
          "Updated: ",
          lastRefreshTime.toLocaleTimeString()
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: EXPORT_FORMATS.map((format) => /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-2", children: [
              /* @__PURE__ */ jsx(FileText, { className: "w-5 h-5 text-blue-600 mr-2" }),
              /* @__PURE__ */ jsx("span", { className: "font-medium text-gray-900", children: format.label })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600", children: format.description }),
            exporting && /* @__PURE__ */ jsxs("div", { className: "flex items-center mt-2 text-sm text-blue-600", children: [
              /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 animate-spin mr-1" }),
              "Exporting..."
            ] })
          ]
        },
  ...
  return /* @__PURE__ */ jsx("div", { className: `min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 space-y-8", children: [
    /* @__PURE__ */ jsxs("div", { className: `text-center ${headerClassName}`, children: [
      /* @__PURE__ */ jsxs("h1", { className: "text-4xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-3", children: [
        /* @__PURE__ */ jsx(History, { className: "w-10 h-10 text-blue-600" }),
        "Transaction History"
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center px-4 py-2 rounded-full text-sm bg-blue-100 text-blue-800", children: [
        /* @__PURE__ */ jsx(RefreshCw, { className: `w-4 h-4 mr-2 ${autoRefresh ? "animate-spin" : ""}` }),
        "Complete transaction tracking and analytics",
        autoRefresh && " \u2022 Auto-refreshing"
      ] })
    ] }),
    !account && /* @__PURE__ */ jsx("div", { className: "bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(AlertCircle, { className: "h-5 w-5 text-yellow-400" }) }),
        /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-yellow-700", children: [
            /* @__PURE__ */ jsx("strong", { children: "Connect Your Wallet:" }),
            " To track your transactions, please connect your wallet first."
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-yellow-600 mt-1", children: "Transaction history is stored locally and tied to your wallet address." })
        ] })
      ] }),
      /* @__PURE__ */ jsx(ConnectButton, { client, theme: "light" })
    ] }) }),
    account && /* @__PURE__ */ jsx("div", { className: "bg-green-100 border-l-4 border-green-500 p-4 rounded", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(CheckCircle, { className: "h-5 w-5 text-green-400" }) }),
        /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-green-700", children: [
            /* @__PURE__ */ jsx("strong", { children: "Wallet Connected:" }),
            " Tracking transactions for ",
            account.address?.slice(0, 8),
            "...",
            account.address?.slice(-6)
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-green-600 mt-1", children: "Transaction history is automatically saved as you use TippingChain" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(RefreshCw, { className: `w-4 h-4 mr-1 ${loading ? "animate-spin" : ""}` }),
            "Refresh"
          ]
        }
      )
    ...
    renderFilters(),
    renderExportSection(),
    /* @__PURE__ */ jsx("div", { className: contentClassName, children: /* @__PURE__ */ jsx(
      TransactionHistory,
      {
        showStats: false,
        showFilters: false,
    ...
    enableRecentActivity && recentTransactions.length > 0 && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between mb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-3", children: [
        /* @__PURE__ */ jsx(Calendar, { className: "w-6 h-6 text-purple-600" }),
        /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-gray-900", children: "Recent Activity" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "space-y-3", children: recentTransactions.map((tx) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-3", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xl", children: tx.type === "tip" ? "\u{1F4B0}" : tx.type === "approval" ? "\u2705" : tx.type === "creator_registration" ? "\u{1F464}" : "\u{1F381}" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "font-medium text-gray-900", children: tx.title }),
                /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600", children: [
                  tx.amount,
                  " ",
                  tx.tokenSymbol,
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
              tx.estimatedUsdValue && /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-green-600", children: formatCurrency(tx.estimatedUsdValue) }),
              /* @__PURE__ */ jsx("span", { className: `px-2 py-1 text-xs rounded-full ${tx.status === "success" ? "bg-green-100 text-green-800" : tx.status === "pending" ? "bg-yellow-100 text-yellow-800" : "bg-red-100 text-red-800"}`, children: tx.status })
            ] })
          ]
        },
        tx.id
    ...
    stats && stats.totalTransactions === 0 && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-lg p-12 text-center", children: [
      /* @__PURE__ */ jsx(History, { className: "w-16 h-16 text-gray-400 mx-auto mb-4" }),
      /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold text-gray-900 mb-2", children: "No Transaction History Yet" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600 mb-6", children: "Your transaction history will appear here once you start using TippingChain." }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-sm text-gray-500 mb-8", children: [
        /* @__PURE__ */ jsx("p", { children: "\u2022 Send tips to creators across multiple blockchain networks" }),
        /* @__PURE__ */ jsx("p", { children: "\u2022 Approve tokens for seamless future transactions" }),
        /* @__PURE__ */ jsx("p", { children: "\u2022 Register as a creator to receive tips" }),
        /* @__PURE__ */ jsx("p", { children: "\u2022 Participate in viewer reward programs" }),
        /* @__PURE__ */ jsx("p", { children: "\u2022 All your activities will be tracked and displayed here" })
      ] }),
