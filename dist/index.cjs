...
var MultiTokenTippingInterface = ({
  ...
  const [inputMode, setInputMode] = React14.useState("token");
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl shadow-lg p-6 max-w-md mx-auto ${className}`, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "space-y-4", children: [
      ...
      selectedToken && /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx("label", { className: "block text-sm font-medium text-gray-700", children: "Amount to tip" }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center bg-gray-100 rounded-md p-1", children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                onClick: () => {
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative", children: inputMode === "token" ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            "input",
            {
              type: "number",
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute right-3 top-2 text-sm text-gray-500", children: "USD" })
        ] }) }),
        amount && tokenPrice > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mt-1 text-xs text-gray-500 text-center", children: inputMode === "token" ? /* @__PURE__ */ jsxRuntime.jsxs("span", { children: [
          amount,
          " ",
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex justify-between items-center mt-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-gray-600", children: [
            ...
            " ",
            selectedToken.symbol,
            tokenPrice > 0 && /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-gray-400 ml-1", children: [
              "(\u2248$",
...
var StreamingPage = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: `min-h-screen bg-gray-900 ${className}`, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-8", children: [
...
var AdminContractControls = ({
  ...
  const { sdk } = sdkConfig;
  const [isPaused, setIsPaused] = React14.useState(null);
  const [isLoading, setIsLoading] = React14.useState(false);
  const [relayerAddress, setRelayerAddress] = React14.useState("");
  const [emergencyWithdrawAmount, setEmergencyWithdrawAmount] = React14.useState("");
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `bg-white shadow-md rounded-lg p-6 ${className}`, children: [
    /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "text-2xl font-bold mb-4", children: "Admin Contract Controls" }),
    errorMessage && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4", children: errorMessage }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-xl font-semibold mb-2", children: "Contract State" }),
        /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "mb-2", children: [
          "Current State: ",
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: isPaused ? "text-red-500" : "text-green-500", children: isPaused === null ? "Loading..." : isPaused ? "Paused" : "Active" })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-xl font-semibold mb-2", children: "Relayer Management" }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-xl font-semibold mb-2", children: "Emergency Operations" }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "input",
          {
            type: "text",
...
var AdvancedStatsDashboard = ({
  ...
  const { sdk } = sdkConfig;
  const [stats, setStats] = React14.useState(null);
  const [activeCreators, setActiveCreators] = React14.useState([]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `bg-white shadow-md rounded-lg p-6 ${className}`, children: [
    /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "text-2xl font-bold mb-4", children: "Advanced Statistics Dashboard" }),
    errorMessage && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4", children: errorMessage }),
    isLoading ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-center py-10", children: "Loading statistics..." }) : /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "bg-blue-50 p-4 rounded-lg shadow", children: [
        /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-lg font-semibold mb-2", children: "Total Tips" }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-3xl font-bold", children: stats?.totalTips || 0 })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "bg-green-50 p-4 rounded-lg shadow", children: [
        /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-lg font-semibold mb-2", children: "Total Rewards" }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-3xl font-bold", children: stats?.totalRewards || 0 })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "bg-purple-50 p-4 rounded-lg shadow", children: [
        /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-lg font-semibold mb-2", children: "Total Value (USDC)" }),
        /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-3xl font-bold", children: [
          "$",
          stats?.totalValue || 0
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "md:col-span-3", children: [
        /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-xl font-semibold mb-2", children: "Active Creators" }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntime.jsxs("table", { className: "min-w-full bg-white border border-gray-200", children: [
          /* @__PURE__ */ jsxRuntime.jsx("thead", { children: /* @__PURE__ */ jsxRuntime.jsxs("tr", { className: "bg-gray-100", children: [
            /* @__PURE__ */ jsxRuntime.jsx("th", { className: "py-2 px-4 border-b text-left", children: "ID" }),
            /* @__PURE__ */ jsxRuntime.jsx("th", { className: "py-2 px-4 border-b text-left", children: "Name" })
          ] }) }),
          /* @__PURE__ */ jsxRuntime.jsx("tbody", { children: activeCreators.length > 0 ? activeCreators.map((creator) => /* @__PURE__ */ jsxRuntime.jsxs("tr", { className: "hover:bg-gray-50", children: [
            /* @__PURE__ */ jsxRuntime.jsx("td", { className: "py-2 px-4 border-b", children: creator.id }),
            /* @__PURE__ */ jsxRuntime.jsx("td", { className: "py-2 px-4 border-b", children: creator.name })
          ] }, creator.id)) : /* @__PURE__ */ jsxRuntime.jsx("tr", { children: /* @__PURE__ */ jsxRuntime.jsx("td", { colSpan: 2, className: "py-2 px-4 text-center text-gray-500", children: "No active creators found." }) }) })
        ] }) })
      ] })
    ] })
  ] });
...
exports.AdminContractControls = AdminContractControls;
exports.AdminDashboard = AdminDashboard;
exports.AdminInterface = AdminInterface;
exports.AdvancedStatsDashboard = AdvancedStatsDashboard;
